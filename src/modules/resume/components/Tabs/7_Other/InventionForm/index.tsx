...
const InventionForm: React.FC = () => {
  useI18nZodErrors('resume.invention')
  const t = useTranslations('Resume.Invention')
  const form = useFormContext<ResumeFormType>()

  const { append, remove, move, fields } = useFieldArray({ control: form.control, name: 'inventions' })
