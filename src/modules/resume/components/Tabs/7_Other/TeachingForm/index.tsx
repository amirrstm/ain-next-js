...
const TeachingForm: React.FC = () => {
  useI18nZodErrors('resume.teaching')
  const t = useTranslations('Resume.Teaching')
  const form = useFormContext<ResumeFormType>()

  const { append, remove, move, fields } = useFieldArray({ control: form.control, name: 'teachings' })
