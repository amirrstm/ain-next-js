...
const SingleAwardForm: React.FC<Props> = ({ position, fieldId, hasMove, moveCard, remove }) => {
    ...
    >
      ...
      <div className="col-span-12">
        <FormField
          ...
          name={`awards.${position}.title`}
          render={({ field }) => (
            <FormItem>
              <FormLabel>{t('resume.award.title')}</FormLabel>
              <FormControl>
      ...
      <div className="col-span-6">
        <FormField
          control={form.control}
          name={`awards.${position}.awarder`}
          render={({ field }) => (
            <FormItem>
              <FormLabel>{t('resume.award.awarder')}</FormLabel>
              <FormControl>
                <Input {...field} inputSize="sm" />
              </FormControl>
      ...
      <div className="col-span-6">
        <FormField
          control={form.control}
          name={`awards.${position}.date`}
          render={({ field }) => (
            <FormItem>
              <FormLabel>{t('resume.award.date')}</FormLabel>
              <FormControl>
                <MonthPicker {...field} />
              </FormControl>
      ...
      <div className="col-span-12">
        <FormField
          control={form.control}
          name={`awards.${position}.summary`}
          render={({ field }) => (
            <FormItem>
              <FormLabel>{t('resume.award.summary')}</FormLabel>
              <FormControl>
                <Input {...field} inputSize="sm" />
              </FormControl>
...
export default SingleAwardForm
