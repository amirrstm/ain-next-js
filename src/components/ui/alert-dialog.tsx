...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title className={cn('font-semibold text-lg', className)} ref={ref} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Description
    className={cn('text-neutral-400 text-sm dark:text-muted-foreground', className)}
    ref={ref}
    {...props}
  />
))
