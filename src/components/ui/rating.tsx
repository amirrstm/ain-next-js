...
const SingleStar: React.FC<SingleProps> = ({ size, fill, onClick }) => (
  <svg
    ...
    className={clsx(
      'text-gray-300 dark:text-gray-500 data-[fill=true]:text-yellow-300 dark:data-[fill=true]:text-yellow-300',
      {
