...
const SingleReferenceForm: React.FC<Props> = ({ position, fieldId, hasMove, moveCard, remove }) => {
    ...
    >
      ...
      <div className="col-span-6">
        <FormField
          ...
          name={`references.${position}.name`}
          render={({ field }) => (
            <FormItem>
              <FormLabel>{t('resume.reference.name')}</FormLabel>
              <FormControl>
      ...
      <div className="col-span-6">
        <FormField
          control={form.control}
          name={`references.${position}.reference`}
          render={({ field }) => (
            <FormItem>
              <FormLabel>{t('resume.reference.reference')}</FormLabel>
              <FormControl>
                <Input {...field} inputSize="sm" />
              </FormControl>
...
export default SingleReferenceForm
