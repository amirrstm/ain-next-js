...
const SingleTeachingForm: React.FC<Props> = ({ position, fieldId, hasMove, moveCard, remove }) => {
    ...
    >
      ...
      <div className="col-span-6 sm:col-span-6">
        <FormField
          ...
          name={`teachings.${position}.title`}
          render={({ field }) => (
            <FormItem>
              <FormLabel>{t('resume.teaching.title')}</FormLabel>
              <FormControl>
      ...
      <div className="col-span-6 sm:col-span-6">
        <FormField
          control={form.control}
          name={`teachings.${position}.institution`}
          render={({ field }) => (
            <FormItem>
              <FormLabel>{t('resume.teaching.institution')}</FormLabel>
              <FormControl>
                <Input {...field} inputSize="sm" />
              </FormControl>
      ...
      <div className="col-span-12">
        <FormField
          control={form.control}
          name={`teachings.${position}.summary`}
          render={({ field }) => (
            <FormItem>
              <FormLabel>{t('resume.teaching.summary')}</FormLabel>
              <FormControl>
                <Input {...field} inputSize="sm" />
              </FormControl>
      ...
      <div className="col-span-6 sm:col-span-3">
        <FormField
          control={form.control}
          name={`teachings.${position}.date`}
          render={({ field }) => (
            <FormItem>
              <FormLabel>{t('resume.teaching.date')}</FormLabel>
              <FormControl>
                <MonthPicker {...field} />
              </FormControl>
      ...
      <LocationForm
        control={form.control}
        name={`teachings.${position}.location`}
        cityClassName="col-span-6 sm:col-span-3"
        stateClassName="col-span-6 sm:col-span-3"
        countryClassName="col-span-6 sm:col-span-3"
      />
    </div>
  )
}

export default SingleTeachingForm
